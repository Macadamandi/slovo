    ...
    >
      ...
      <ul className="list">
        <li className="list-item">
          <NavLink to="/" href="#" className="list-link">
            <svg
        ...
        <li className="list-item">
          <NavLink to="/sets" href="#" className="list-link">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512"
              width="24"
        ...
        <li className="list-item">
          <NavLink to="/favorities" href="#" className="list-link">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512"
              width="24"
        ...
        <li className="list-item">
          <NavLink to="/dictionary" href="#" className="list-link">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              width="24"
